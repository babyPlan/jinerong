...
@interface JERViewController ()


@end

@implementation JERViewController

@synthesize leftNaviBtn,rightNaviBtn,bg,m_tableView,SHRequest_,currentRequest;
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)dealloc
{
    ...
    [self.SHRequest_ clearDelegatesAndCancel];
}
...
{
    self.redPointImg=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"red_point"]];
    [self.redPointImg setFrame:CGRectMake(40,10, PARENT_WIDTH(self.redPointImg), PARENT_HEIGHT(self.redPointImg))];
    [self.rightNaviBtn addSubview:self.redPointImg];
...
//    
//    UIImageView *imageview=[[UIImageView alloc] initWithImage:img];
//    [imageview setFrame:CGRectMake(44-PARENT_WIDTH(imageview), (44-PARENT_HEIGHT(imageview))/2.0, PARENT_WIDTH(imageview), PARENT_HEIGHT(imageview))];
//    self.notifyNumberView=[[NotifyNumberView alloc] initWithFrame:CGRectMake(-8, -8, 16, 16)];
//    [imageview addSubview:self.notifyNumberView];
//    //    [self.rightNaviBtn setImage:img forState:UIControlStateNormal];
//    //    [self.rightNaviBtn setImageEdgeInsets:UIEdgeInsetsMake((44-PARENT_HEIGHT(imageview))/2.0, 44-PARENT_WIDTH(imageview), (44-PARENT_HEIGHT(imageview))/2.0, 0)];
//    [self.rightNaviBtn addSubview:imageview];
//    UIBarButtonItem * rightButton = [[UIBarButtonItem alloc]initWithCustomView:self.rightNaviBtn];
//    self.navigationItem.rightBarButtonItem=rightButton;
//}
...
//    
//    UIImageView *imageview=[[UIImageView alloc] initWithImage:img];
//    [imageview setFrame:CGRectMake(0, (44-PARENT_HEIGHT(imageview))/2.0, PARENT_WIDTH(imageview),PARENT_HEIGHT(imageview) )];
//    float labelWidth=[MyFounctions calculateTextWidth:title font:[UIFont systemFontOfSize:12.0]];
//    UILabel *label=[[UILabel alloc] initWithFrame:CGRectMake(PARENT_WIDTH(imageview)+5, 0, labelWidth, 44)];
//    [label setFont:[UIFont systemFontOfSize:12.0]];
//    [label setTextColor:[UIColor whiteColor]];
//    label.text=title;
//    
//    self.rightNaviBtn = [UIButton buttonWithType:UIButtonTypeCustom];
//    [self.rightNaviBtn setFrame:CGRectMake(0, 0, PARENT_WIDTH(imageview)+5+PARENT_WIDTH(label), 44)];
//    self.rightNaviBtn.backgroundColor=[UIColor clearColor];
//    [self.rightNaviBtn addSubview:imageview];
//    [self.rightNaviBtn addSubview:label];
//    UIBarButtonItem * rightButton = [[UIBarButtonItem alloc]initWithCustomView:self.rightNaviBtn];
//    self.navigationItem.rightBarButtonItem=rightButton;
//}
